...
```sh
$ npx playwright-cli --save-storage=auth.json codegen
...
```sh
$ npx playwright-cli --load-storage=auth.json open my.web.app
$ npx playwright-cli --load-storage=auth.json codegen my.web.app
